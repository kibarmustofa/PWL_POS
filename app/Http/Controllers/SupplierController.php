...
class SupplierController extends Controller
{
    ...
    {
        $suppliers = SupplierModel::select('supplier_id', 'supplier_id', 'supplier_nama', 'supplier_alamat', 'supplier_telepon');
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'supplier_telepon' => 'required|string|max:255',
        ]);
    ...
    {
        $supplier = SupplierModel::select('supplier_id', 'supplier_nama', 'supplier_alamat', 'supplier_telepon')
            ->orderBy('supplier_id')
            ->get();
        ...
        $sheet->setCellValue('F1', 'Telepon Supplier');
        ...
        foreach ($supplier as $key => $value) {
            ...
            $sheet->setCellValue('F' . $baris, $value->supplier_telepon);
            $baris++;
            $no++;
        }
